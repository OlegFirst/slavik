...
├── simulation/                      # 🔥 Simulation Service (Port 8095)
│   ├── engines/                     # 7 simulation engines
│   │   ├── jaamsim/                 # JaamSim discrete-event + BCM exercise orchestrator
│   │   ├── monte_carlo_engine.py    # Monte Carlo risk analysis
│   │   ├── scenario_engine.py       # BCM scenario execution
│   │   ├── what_if_engine.py        # What-if analysis
│   │   ├── bia_ciw_engine.py        # Queue theory (M/M/c, Little's Law)
│   │   └── advanced_bia_engine.py   # Multi-resource BIA
│   ├── api/                         # 6 API routers, 31 endpoints
│   │   ├── simulation_router.py     # Simulation lifecycle management
│   │   ├── scenario_router.py       # Scenario CRUD operations
│   │   ├── scenario_advanced_router.py # AI-powered scenario generation
│   │   ├── scenario_library_router.py # Public + tenant scenarios
│   │   ├── execution_router.py      # Execution monitoring
│   │   └── bridge_router.py         # Legacy compatibility
│   ├── integration/                 # 11 integration clients
│   │   ├── eventbus_client.py       # EventBus pub/sub (8 events)
│   │   ├── service_discovery_client.py # Consul registration
│   │   ├── ai_foundation_client.py  # RAG search, LLM generation
│   │   ├── workflow_intelligence_client.py # Case library integration
│   │   ├── thehive_client.py        # TheHive BCM exercises
│   │   └── nics_client.py           # NICS emergency management
│   ├── storage/                     # Database models (simulation schema)
│   │   └── models.py                # 4 tables (simulations, scenarios, executions, results)
│   ├── core/                        # Core functionality
│   │   ├── ai_scenario_generator.py # AI-powered scenario generation
│   │   ├── flow_manager.py          # Orchestration flow control
│   │   └── metrics.py               # Prometheus metrics (6 KPIs)
