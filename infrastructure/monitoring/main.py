...
class Config:
    ...
    # This dict now serves as ISO clause mapping, not health checking
    MONITORED_SERVICES = {
        "intelligent_gateway": {
            "url": "http://localhost:8000",
            "type": "gateway",
            "iso_clauses": ["4.1", "6.1"],  # Context & Risk
            "description": "Intelligent Gateway - Entry point for all BCM services"
        },
        "eventbus": {
            "url": "http://localhost:8001",
            "type": "platform",
            "iso_clauses": ["7.4"],  # Communication
            "description": "Event Bus - Inter-service communication"
        },
        "ai_orchestration": {
            "url": "http://localhost:8002",
            "type": "platform",
            "iso_clauses": ["8.3"],  # Business Continuity Strategies
            "description": "AI Orchestration - Intelligent decision support"
        },
        "bpmn_workflow": {
            "url": "http://localhost:8003",
            "type": "platform",
            "iso_clauses": ["8.4"],  # Business Continuity Procedures
            "description": "BPMN Workflow - Process automation"
        },
        "coordination_center": {
            "url": "http://localhost:8004",
            "type": "platform",
            "iso_clauses": ["5.3", "8.4.2"],  # Leadership & Incident Response
            "description": "Coordination Center - Crisis management coordination"
        },
        "project_intelligence": {
            "url": "http://localhost:8025",
            "type": "intelligence",
            "iso_clauses": ["9.1"],  # Performance Evaluation
            "description": "Project Intelligence - BCM project analytics"
        },
        "ai_intelligence": {
            "url": "http://localhost:8032",
            "type": "intelligence",
            "iso_clauses": ["9.1", "10.2"],  # Monitoring & Continual Improvement
            "description": "AI Intelligence - Predictive analytics"
        },
        "notification_service": {
            "url": "http://localhost:8035",
            "type": "platform",
            "iso_clauses": ["7.4"],  # Communication
            "description": "Notification Service - Alert distribution"
        },
        "process_mining": {
            "url": "http://localhost:8040",
            "type": "analytics",
            "iso_clauses": ["9.1", "9.3"],  # Performance & Management Review
            "description": "Process Mining - Process discovery & analysis"
        },
        # BCM Platform Services (ISO 22301 Core Compliance)
        "planning_service": {
            "url": "http://localhost:8011",
            "type": "bcm",
            "iso_clauses": ["8.3"],  # Business Continuity Strategies
            "description": "Planning Service - ISO 22301 Clause 8.3: Business Continuity Strategies",
            "compliance_critical": True
        },
        "plans_service": {
            "url": "http://localhost:8023",
            "type": "bcm",
            "iso_clauses": ["8.4"],  # Business Continuity Plans & Procedures
            "description": "Plans Service - ISO 22301 Clause 8.4: Business Continuity Plans",
            "compliance_critical": True
        },
        "bia_service": {
            "url": "http://localhost:8012",
            "type": "bcm",
            "iso_clauses": ["8.2.2"],  # Business Impact Analysis
            "description": "BIA Service - ISO 22301 Clause 8.2.2: Business Impact Analysis",
            "compliance_critical": True,
            "metrics": ["MTPD", "RTO", "RPO"]
        },
        "compliance_service": {
            "url": "http://localhost:8014",
            "type": "bcm",
            "iso_clauses": ["9.2", "10.1", "10.2"],  # Audit, Nonconformity, Improvement
            "description": "Compliance Service - ISO 22301 Clauses 9.2, 10.1, 10.2: Compliance Management",
            "compliance_critical": True
        },
        "learning_service": {
            "url": "http://localhost:8021",
            "type": "bcm",
            "iso_clauses": ["7.2"],  # Competence
            "description": "Learning Service - ISO 22301 Clause 7.2: Competence & Training",
            "compliance_critical": True
        },
        "governance_service": {
            "url": "http://localhost:8022",
            "type": "bcm",
            "iso_clauses": ["5.3", "7.1", "7.3"],  # Leadership, Resources, Awareness
            "description": "Governance Service - ISO 22301 Clauses 5.3, 7.1, 7.3: Governance",
            "compliance_critical": True
        },
        "validation_service": {
            "url": "http://localhost:8025",
            "type": "bcm",
            "iso_clauses": ["8.5"],  # Exercising & Testing
            "description": "Validation Service - ISO 22301 Clause 8.5: Exercising & Testing",
            "compliance_critical": True
        },
        "documents_service": {
            "url": "http://localhost:8024",
            "type": "bcm",
            "iso_clauses": ["7.5"],  # Documented Information
            "description": "Documents Service - ISO 22301 Clause 7.5: Document Management",
            "compliance_critical": True
        },
        "community_portal": {
            ...
            "type": "bcm",
            "iso_clauses": ["7.4"],  # Communication
            "description": "Community Portal - ISO 22301 Clause 7.4: Internal/External Communication",
            "compliance_critical": False
        },
        "community_marketplace": {
            "url": "http://localhost:8032",
            "type": "bcm",
            "iso_clauses": ["7.1", "8.1"],  # Resources & Operational Planning
            "description": "Marketplace - ISO 22301 Clause 7.1: Resource Management",
            "compliance_critical": False
        },
        "response_service": {
            "url": "http://localhost:8041",
            "type": "bcm",
            "iso_clauses": ["8.4"],  # Incident Response Structure
            "description": "Response Service - ISO 22301 Clause 8.4: Incident Response",
            "compliance_critical": True
        },
    }
