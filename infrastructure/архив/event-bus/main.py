...
EVENT_TYPES = {
    ...
    # Portal - Knowledge Hub Events
    "portal.knowledge.article_created": {"required_fields": ["article_id", "title", "category"]},
    "portal.knowledge.article_published": {"required_fields": ["article_id", "title", "category"]},
    "portal.knowledge.article_verified": {"required_fields": ["article_id", "verified"]},

    # Portal - Scenario Events
    "portal.scenarios.deployed": {"required_fields": ["scenario_id", "scenario_name", "exercise_id"]},
    "portal.scenarios.reviewed": {"required_fields": ["scenario_id", "review_id", "rating"]},

    # Portal - Forum Events
    "portal.forum.topic_created": {"required_fields": ["topic_id", "title", "category_id"]},
    "portal.forum.post_created": {"required_fields": ["post_id", "topic_id"]},
    "portal.forum.solution_marked": {"required_fields": ["topic_id", "post_id"]},
    "portal.forum.content_flagged": {"required_fields": ["flag_id", "content_type", "content_id", "reason"]},
    "portal.forum.moderation_action": {"required_fields": ["flag_id", "action"]},

    # Portal - Gamification Events
    "portal.gamification.reputation_earned": {"required_fields": ["points", "reason"]},
    "portal.gamification.badge_earned": {"required_fields": ["badge_id", "badge_name", "badge_tier"]},

    # Marketplace - Specialist Events
    "marketplace.specialist.registered": {"required_fields": ["specialist_id", "user_id"]},
    "marketplace.specialist.verified": {"required_fields": ["specialist_id", "verified"]},
    "marketplace.specialist.profile_updated": {"required_fields": ["specialist_id"]},

    # Marketplace - Project Events
    "marketplace.project.created": {"required_fields": ["project_id", "client_id", "service_type"]},
    "marketplace.project.published": {"required_fields": ["project_id"]},
    "marketplace.project.assigned": {"required_fields": ["project_id", "specialist_id"]},
    "marketplace.project.completed": {"required_fields": ["project_id", "specialist_id"]},

    # Marketplace - Proposal Events
    "marketplace.proposal.submitted": {"required_fields": ["proposal_id", "project_id", "specialist_id"]},
    "marketplace.proposal.accepted": {"required_fields": ["proposal_id", "project_id", "specialist_id"]},
    "marketplace.proposal.rejected": {"required_fields": ["proposal_id", "project_id"]},

    # Marketplace - Review Events
    "marketplace.review.created": {"required_fields": ["review_id", "project_id", "specialist_id", "rating"]},
    "marketplace.review.responded": {"required_fields": ["review_id", "specialist_id"]}
}
