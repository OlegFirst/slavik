...
class DevOpsAgent:
    ...
    async def run_compliance_checks(self) -> Dict:
        """
        Run platform compliance checks (6 priorities)

        Previously from: /infrastructure/tools/project-manager/
        Now: Integrated in DevOps Agent
    ...
    async def scan_infrastructure(self, scan_type: str = "full") -> Dict:
        ...
        Args:
            scan_type: 'full', 'events', 'containers', 'deployments', 'compliance'
