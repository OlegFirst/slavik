...
The Compliance Service manages regulatory compliance and standards adherence including gap analysis, audit management, and certification tracking. It implements compliance monitoring with automated evidence collection.

## Metrics

| Metric | Value |
|--------|-------|
| **Total Lines of Code** | 17,480 |
| **Python Files** | 55 |
| **Classes** | 136 |
| **Functions** | 41 |
| **API Endpoints** | 95 |
...
# Run with coverage
pytest tests/ --cov=compliance_service --cov-report=html
```
...
await client.start_workflow(type="compliance")
```
