...
The Мониторинг provides core business continuity management functionality.
...
```bash
cd platform-services/мониторинг
...
# Run with coverage
pytest tests/ --cov=мониторинг --cov-report=html
```
...
await client.start_workflow(type="мониторинг")
```
