...
The Community Service enables knowledge sharing, collaboration, and best practice exchange among BCM practitioners. It implements community features including forums, knowledge bases, and peer review capabilities.

## Metrics

| Metric | Value |
|--------|-------|
| **Total Lines of Code** | 18,334 |
| **Python Files** | 70 |
| **Classes** | 170 |
| **Functions** | 8 |
| **API Endpoints** | 107 |
...
```bash
cd platform-services/community-service
...
# Run with coverage
pytest tests/ --cov=community_service --cov-report=html
```
...
await client.start_workflow(type="community")
```
