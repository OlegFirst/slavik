...
class GamificationEngine:
    ...
    @track_learning_operation(engine="gamification_engine", operation="calculate_profile")
    ...
    @track_gamification_event(event_type="badge_award")
...
class LeaderboardGenerator:
    ...
    @track_learning_operation(engine="leaderboard_generator", operation="generate_global_leaderboard")
