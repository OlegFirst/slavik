...
class DependencyMapper:
    ...
    def _add_dependency(self, from_module: str, to_module: str, file_path: Path,
        ...
        # Игнорировать стандартные библиотеки
    ...
    def generate_graph(self, output_file: str = "tools/reports/dependency_graph.png"):
    ...
    def save_results(self, output_dir: str = "tools/reports"):
