...
class PatternDetector:
    ...
    @track_pattern_detection
    @track_learning_operation(engine="pattern_detector", operation="detect_patterns")
...
class ScenarioAnalyzer:
    ...
    @track_learning_operation(engine="scenario_analyzer", operation="analyze_scenario")
