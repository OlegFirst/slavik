...
{f"EXISTING PLAN (to update):\\n{existing_plan[:500]}..." if existing_plan else "NEW PLAN - comprehensive creation"}

{f"EXERCISE LESSONS (incorporate):\\n{self._format_lessons(lessons)}" if lessons else ""}
...
Ensure compliance with {', '.join(standards)} and industry best practices.
