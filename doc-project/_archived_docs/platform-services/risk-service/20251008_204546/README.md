...
The Risk Service implements comprehensive risk management including risk identification, assessment, treatment planning, and monitoring. It provides risk matrices, heat maps, and integration with mitigation workflows.

## Metrics

| Metric | Value |
|--------|-------|
| **Total Lines of Code** | 6,126 |
| **Python Files** | 23 |
| **Classes** | 48 |
| **Functions** | 23 |
| **API Endpoints** | 29 |
...
# Run with coverage
pytest tests/ --cov=risk_service --cov-report=html
```
...
await client.start_workflow(type="risk")
```
