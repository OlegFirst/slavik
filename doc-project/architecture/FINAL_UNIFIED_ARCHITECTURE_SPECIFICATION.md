...
│   ├── Workflow Engine /             # 🔄 раньше PLATFORM CORE (workflow, etc.)
...
│
├── xpertise-center/              # 🎓 DOMAIN PLUGIN MANAGER
│   │
...
## 🔄 Workflow Orchestration: Temporal Cloud + EventBus

**📖 See:** [TEMPORAL_EVENTBUS_ARCHITECTURE.md](TEMPORAL_EVENTBUS_ARCHITECTURE.md) ⭐⭐⭐

**Architecture Decision:**
- ✅ **Temporal Cloud** = orchestration долгоживущих бизнес-процессов (BIA, Risk, Incident Response, etc.)
- ✅ **EventBus (RabbitMQ)** = integration, notifications, real-time updates
- ✅ **Оба используются ВМЕСТЕ** (дополняют друг друга)

**Key Points:**
```
Temporal Orchestrates Process          EventBus Integrates Services
        ↓                                       ↓
BIA Workflow (2-4 weeks)      →    Events: bia.started, bia.completed
  - Persistent state                  - Notifications (email/SMS)
  - Human approvals                   - Dashboard updates (WebSocket)
  - Retry logic                       - Audit trail
  - Governance checkpoints            - Service integration
```

**Processes через Temporal (~10-15 workflows):**
1. BIA Workflow, 2. Risk Assessment, 3. Incident Response, 4. Compliance Audit, 5. DR Testing, etc.

**Full documentation:**
- [TEMPORAL_INTEGRATION_STRATEGY.md](../intelligent-core/workflow_intelligence/TEMPORAL_INTEGRATION_STRATEGY.md) - Полное описание Temporal
- [PROCESSES_MAPPING.md](../intelligent-core/workflow_intelligence/PROCESSES_MAPPING.md) - Какие процессы через Temporal
