...
# Stub AI Colleague class for compatibility with ai_colleagues package
class ProjectIntelligenceAI:
    """
    Project Intelligence AI Colleague (Stub)

    This is a stub class for import compatibility.
    The actual Project Intelligence functionality is provided via FastAPI service above.

    Note: This service uses ProjectIntelligenceEngine class for core logic.
    For AI colleague interface, use ProjectIntelligenceEngine directly or via HTTP API.
    """
    def __init__(self, *args, **kwargs):
        logger.warning(
            "ProjectIntelligenceAI stub initialized. "
            "Use ProjectIntelligenceEngine or HTTP API for actual functionality."
        )
        self.engine = ProjectIntelligenceEngine()

    def __repr__(self):
        return "<ProjectIntelligenceAI (Service Stub)>"
