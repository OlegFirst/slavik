...
The Governance Service implements organizational governance frameworks for business continuity management, including stakeholder management, decision-making processes, and organizational context analysis. It provides tools for governance structure definition and accountability tracking.

## Metrics

| Metric | Value |
|--------|-------|
| **Total Lines of Code** | 7,224 |
| **Python Files** | 27 |
| **Classes** | 90 |
| **Functions** | 4 |
| **API Endpoints** | 46 |
...
```bash
cd platform-services/governance-service
...
# Run with coverage
pytest tests/ --cov=governance_service --cov-report=html
```
...
await client.start_workflow(type="governance")
```
