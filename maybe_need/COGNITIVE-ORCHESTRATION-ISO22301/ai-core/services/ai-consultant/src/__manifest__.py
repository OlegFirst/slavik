...
• Пункт 9.1: Мониторинг эффективности''',
    ...
    'assets': {
        'web.assets_backend': [
            'bcm_ai_consultant/static/src/xml/ai_consultant_widget.xml',
            'bcm_ai_consultant/static/src/js/ai_consultant_widget.js',
            'bcm_ai_consultant/static/src/css/ai_consultant.css',
        ],
    },
    'installable': True,
    'application': False,
