...
const scenarioOrchestratorService = {
  ...
  async generateScenario(params) {
    try {
      const response = await apiClient.post('/scenarios/generate', {
  ...
  async getGenerationStatus(generationId) {
    try {
      const response = await apiClient.get(`/scenarios/generation/${generationId}/status`)
  ...
  async saveScenario(scenarioId, metadata = {}) {
    try {
      const response = await apiClient.post(`/scenarios/${scenarioId}/save`, {
  ...
  async getTemplate(templateId) {
    try {
      const response = await apiClient.get(`/scenarios/templates/${templateId}`)
      return response.data
    } catch (error) {
  ...
  async getCategories() {
    try {
      const response = await apiClient.get('/scenarios/categories')
  ...
  async getIndustryTypes() {
    try {
      const response = await apiClient.get('/scenarios/industries')
  ...
  async getAvailableSystems(organizationType) {
    try {
      const response = await apiClient.get('/scenarios/systems', {
  ...
  async cancelGeneration(generationId) {
    try {
      const response = await apiClient.post(`/scenarios/generation/${generationId}/cancel`)
      return response.data
    } catch (error) {
  ...
  async getGenerationHistory(filters = {}) {
    try {
      const response = await apiClient.get('/scenarios/generation/history', {
        params: {
