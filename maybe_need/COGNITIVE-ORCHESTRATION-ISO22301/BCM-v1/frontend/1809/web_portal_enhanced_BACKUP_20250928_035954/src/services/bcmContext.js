...
class BCMContextService {
  ...
  async getStakeholders(filters = {}) {
    try {
      const response = await apiClient.post(this.stakeholderURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async recordCommunication(stakeholderId, communicationData) {
    try {
      const response = await apiClient.post('/web/dataset/call_kw/bcm.stakeholder.communication', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getInternalFactors() {
    try {
      const response = await apiClient.post(this.factorURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getStakeholderRequirements() {
    try {
      const response = await apiClient.post(this.requirementURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getRecentActivities(limit = 10) {
    try {
      const response = await apiClient.post('/web/dataset/call_kw/mail.message', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'mail.message',
  ...
  async getReviewSchedule() {
    try {
      const response = await apiClient.post('/web/dataset/call_kw/bcm.context.review', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
