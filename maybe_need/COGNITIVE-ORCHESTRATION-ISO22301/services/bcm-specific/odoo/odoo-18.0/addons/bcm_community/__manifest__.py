...
* Analytics and reporting
    ...
    'depends': [
        ...
        'website',
        'portal',
        'website_forum',  # Use Odoo's built-in forum
        'bcm_core',
        'bcm_scenario_hub',
        'bcm_governance',  # For compliance integration
    ],
    'data': [
        # Security
    ...
    'demo': [
        'demo/forum_demo_data.xml',
        'demo/knowledge_demo_data.xml',
    ],
    # Assets - temporarily disabled, need to create missing files
    # 'assets': {
    #     'web.assets_frontend': [
    #         'bcm_community/static/src/css/forum.css',
    #         'bcm_community/static/src/css/knowledge_portal.css',
    #         'bcm_community/static/src/js/forum.js',
    #         'bcm_community/static/src/js/knowledge_search.js',
    #     ],
    #     'web.assets_backend': [
    #         'bcm_community/static/src/css/backend_forum.css',
    #         'bcm_community/static/src/css/knowledge_portal.css',
    #     ],
    # },
    'installable': True,
