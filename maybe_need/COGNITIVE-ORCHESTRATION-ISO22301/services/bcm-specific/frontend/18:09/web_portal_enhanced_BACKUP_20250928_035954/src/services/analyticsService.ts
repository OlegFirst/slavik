...
// API Configuration
const ANALYTICS_BASE_URL = import.meta.env.VUE_APP_ANALYTICS_URL || 'http://localhost:8069/api/analytics'
const LEARNING_BASE_URL = import.meta.env.VUE_APP_LEARNING_URL || 'http://localhost:8085/learning'
const KNOWLEDGE_BASE_URL = import.meta.env.VUE_APP_KNOWLEDGE_URL || 'http://localhost:8069/bcm/community'
