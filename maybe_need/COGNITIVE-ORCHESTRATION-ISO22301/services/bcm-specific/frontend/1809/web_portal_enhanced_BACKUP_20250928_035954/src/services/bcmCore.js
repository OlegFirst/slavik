...
class BCMCoreService {
  ...
  async getOrganizationContext() {
    try {
      const response = await apiClient.post(this.contextURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'bcm.context',
  ...
  async triggerBIA(processIds = []) {
    try {
      const response = await apiClient.post('/web/dataset/call_kw/bcm.bia', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'bcm.bia',
  ...
  async createIncident(incidentData) {
    try {
      const response = await apiClient.post('/web/dataset/call_kw/bcm.incident', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'bcm.incident',
