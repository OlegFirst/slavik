...
const API_BASE_URL = import.meta.env.VITE_ODOO_URL || 'http://localhost:8069'
const LMS_API_URL = import.meta.env.VITE_LMS_URL || 'http://localhost:8006'
const AI_ORCHESTRATOR_URL = import.meta.env.VITE_AI_ORCHESTRATOR_URL || 'http://localhost:8080'
