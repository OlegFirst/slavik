...
const BCMAdminControlCenter: React.FC = () => {
  ...
  const [platforms, setPlatforms] = useState([
    ...
    { id: 7, name: 'Digital Twin Management', url: '/digital-twin', icon: 'Users', description: 'Digital Twin ecosystem management' }
  ]);
  ...
  const openPlatform = (url: string, name: string) => {
    ...
    if (url.startsWith('/')) {
      console.log(`🔗 Navigating to ${name} at ${url}`);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-6">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-slate-900">BCM Unified Platform</h1>
            <p className="text-slate-600 mt-2">Complete Business Continuity Management Suite</p>
