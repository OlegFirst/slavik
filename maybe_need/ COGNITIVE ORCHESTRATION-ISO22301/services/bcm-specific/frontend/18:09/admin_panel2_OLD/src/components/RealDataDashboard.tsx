...
// Legacy imports for compatibility - will be replaced
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="text-center">
              <div className={`text-2xl font-bold ${
                ...
                platformHealth.overall_status === 'healthy' ? 'bg-green-100 text-green-800' :
                platformHealth.overall_status === 'warning' ? 'bg-yellow-100 text-yellow-800' : 'bg-red-100 text-red-800'
              }`}>
                {platformHealth.overall_status}
              </span>
              </div>
