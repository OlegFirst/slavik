...
class BCMIncidentManagementService {
  ...
  async declareEmergency(emergencyData) {
    try {
      const response = await apiClient.post(this.emergencyURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'bcm.emergency',
  ...
  async getCrisisEvents() {
    try {
      const response = await apiClient.post(this.crisisURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getRecoveryProcesses() {
    try {
      const response = await apiClient.post(this.recoveryURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getIncidentTimeline(incidentId) {
    try {
      const response = await apiClient.post('/web/dataset/call_kw/bcm.incident.timeline', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
