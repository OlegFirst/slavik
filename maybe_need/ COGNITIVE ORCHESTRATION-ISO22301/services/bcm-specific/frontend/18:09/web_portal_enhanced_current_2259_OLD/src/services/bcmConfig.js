...
class BCMConfigService {
  ...
  async getModules() {
    try {
      const response = await api.post(this.moduleURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'bcm.module',
  ...
  async getIntegrations() {
    try {
      const response = await api.post(this.integrationURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getBackups() {
    try {
      const response = await api.post(this.backupURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getAuditLogs(filters = {}) {
    try {
      const response = await api.post('/web/dataset/call_kw/bcm.config.audit', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getConfigHistory(section, limit = 20) {
    try {
      const response = await api.post('/web/dataset/call_kw/bcm.config.history', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
