...
class BCMPlansService {
  ...
  async getTestingSchedule(filters = {}) {
    try {
      const response = await api.post(this.testURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'bcm.plan.test',
  ...
  async getActivationHistory(limit = 20) {
    try {
      const response = await api.post(this.activationURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getPlanTemplates() {
    try {
      const response = await api.post('/web/dataset/call_kw/bcm.plan.template', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getPlanWorkflows(planId) {
    try {
      const response = await api.post('/web/dataset/call_kw/bcm.plan.workflow', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getUsers() {
    try {
      const response = await api.post('/web/dataset/call_kw/res.users', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'res.users',
  ...
  async getReviewHistory(planId) {
    try {
      const response = await api.post('/web/dataset/call_kw/bcm.plan.review', {
        jsonrpc: '2.0',
        method: 'call',
        params: {
