...
export default {
  ...
  async getRisks(filters = {}) {
    try {
      ...
      const response = await api.get(`/governance/risks?${params}`)
  ...
  async createRisk(riskData) {
    try {
      const response = await api.post('/api/bcm_governance/risks', {
        name: riskData.name,
  ...
  async updateRisk(riskId, riskData) {
    try {
      const response = await api.put(`/api/bcm_governance/risks/${riskId}`, riskData)
      return response.data
    } catch (error) {
  ...
  async deleteRisk(riskId) {
    try {
      await api.delete(`/api/bcm_governance/risks/${riskId}`)
      return { success: true }
    } catch (error) {
  ...
  async getRiskHeatMap() {
    try {
      const response = await api.get('/api/bcm_governance/risks/heatmap')
      return response.data
    } catch (error) {
  ...
  async getPolicies(filters = {}) {
    try {
      const response = await api.get('/api/bcm_governance/policies', { params: filters })
      return response.data
    } catch (error) {
  ...
  async createPolicy(policyData) {
    try {
      const response = await api.post('/api/bcm_governance/policies', {
        ...policyData,
        version: '1.0',
        status: 'draft',
  ...
  async updatePolicy(policyId, policyData, createNewVersion = true) {
    try {
      ...
      const response = await api.put(endpoint, policyData)
      return response.data
    } catch (error) {
  ...
  async getPolicyVersions(policyId) {
    try {
      const response = await api.get(`/api/bcm_governance/policies/${policyId}/versions`)
      return response.data
    } catch (error) {
  ...
  async approvePolicy(policyId, approvalData) {
    try {
      const response = await api.post(`/api/bcm_governance/policies/${policyId}/approve`, {
  ...
  async getGovernanceStructure() {
    try {
      const response = await api.get('/api/bcm_governance/structure')
      return response.data
    } catch (error) {
  ...
  async updateGovernanceStructure(structureData) {
    try {
      const response = await api.put('/api/bcm_governance/structure', structureData)
      return response.data
    } catch (error) {
  ...
  async getAuditTrail(filters = {}) {
    try {
      const response = await api.get('/api/bcm_governance/audit-trail', { params: filters })
      return response.data
    } catch (error) {
  ...
  async createAuditEntry(entryData) {
    try {
      const response = await api.post('/api/bcm_governance/audit-trail', {
        ...entryData,
  ...
  async getRiskAppetite() {
    try {
      const response = await api.get('/api/bcm_governance/risk-appetite')
      return response.data
    } catch (error) {
  ...
  async updateRiskAppetite(appetiteData) {
    try {
      const response = await api.put('/api/bcm_governance/risk-appetite', appetiteData)
      return response.data
    } catch (error) {
