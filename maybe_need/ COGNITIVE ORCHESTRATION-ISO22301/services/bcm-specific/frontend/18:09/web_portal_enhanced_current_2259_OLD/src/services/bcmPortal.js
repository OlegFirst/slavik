...
class BCMPortalService {
  ...
  async getServiceRequests(filters = {}) {
    try {
      ...
      return await this.api.searchRead(
  ...
  async createServiceRequest(requestData) {
    try {
      ...
      const requestId = await this.api.create('bcm.portal.service.request', values)
  ...
  async enrollInTraining(programId, userId = null) {
    try {
      ...
      const enrollmentId = await this.api.create('bcm.training.enrollment', values)
  ...
  async registerForExercise(exerciseId, participantData) {
    try {
      ...
      const participationId = await this.api.create('bcm.exercise.participation', values)
  ...
  async markNotificationRead(notificationId) {
    try {
      await this.api.write('bcm.portal.notification', [notificationId], { is_read: true })
    } catch (error) {
  ...
  async sendNotification(notificationData) {
    try {
      ...
      return await this.api.create('bcm.portal.notification', values)
    } catch (error) {
  ...
  async getClientId() {
    ...
    try {
      const clients = await this.api.searchRead(
        'res.partner',
  ...
  async getCurrentUserId() {
    try {
      const response = await this.api.call('res.users', 'get_current_user_id', [])
      return response
    } catch (error) {
