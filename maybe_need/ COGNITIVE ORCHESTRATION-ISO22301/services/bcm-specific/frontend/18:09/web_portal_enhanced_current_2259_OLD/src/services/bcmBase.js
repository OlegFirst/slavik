...
class BCMBaseService {
  ...
  async getOrganizations() {
    try {
      const response = await api.post(this.organizationURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
  ...
  async getLocations() {
    try {
      const response = await api.post(this.locationURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'bcm.location',
  ...
  async getAssets() {
    try {
      const response = await api.post(this.assetURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'bcm.asset',
  ...
  async getContacts() {
    try {
      const response = await api.post(this.contactURL, {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: 'bcm.contact',
  ...
  async createEntry(type, entryData) {
    ...
    try {
      const response = await api.post(urlMap[type], {
        jsonrpc: '2.0',
        method: 'call',
        params: {
          model: modelMap[type],
