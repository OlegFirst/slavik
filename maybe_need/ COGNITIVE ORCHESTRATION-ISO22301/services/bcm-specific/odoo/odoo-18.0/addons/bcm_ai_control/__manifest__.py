...
ESSENTIAL FOR DIGITAL BCM ORGANISM ADMINISTRATION
    ...
    # 'demo': [
    #     'demo/ai_control_demo.xml',
    # ],
    # 'assets': {
    #     'web.assets_backend': [
    #         'bcm_ai_control/static/src/css/ai_control.css',
    #         'bcm_ai_control/static/src/js/ai_dashboard.js',
    #     ],
    # },
    'installable': True,
    'application': True,
    'auto_install': False,
    # External dependencies removed for easier installation
    # AI tools accessed via separate service
}