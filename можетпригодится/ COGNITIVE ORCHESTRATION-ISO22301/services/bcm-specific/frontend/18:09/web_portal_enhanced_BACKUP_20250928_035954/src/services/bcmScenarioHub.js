...
class BCMScenarioHubService {
  ...
  async getScenarios(params = {}) {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios`, {
        params: {
          page: params.page || 1,
  ...
  async getScenario(scenarioId) {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios/${scenarioId}`)
      return response.data
    } catch (error) {
  ...
  async getScenarioVersions(scenarioId) {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios/${scenarioId}/versions`)
      return response.data
    } catch (error) {
  ...
  async publishScenario(scenarioData) {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios`, scenarioData)
  ...
  async updateScenario(scenarioId, updates) {
    try {
      const response = await apiClient.put(`${this.baseURL}/scenarios/${scenarioId}`, updates)
  ...
  async getScenarioRatings(scenarioId) {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios/${scenarioId}/ratings`)
      return response.data
    } catch (error) {
  ...
  async rateScenario(scenarioId, rating, review = null) {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios/${scenarioId}/ratings`, {
        rating,
        review
      })
  ...
  async getScenarioReviews(scenarioId, params = {}) {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios/${scenarioId}/reviews`, {
        params: {
          page: params.page || 1,
  ...
  async addReview(scenarioId, reviewData) {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios/${scenarioId}/reviews`, reviewData)
  ...
  async toggleFavorite(scenarioId) {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios/${scenarioId}/favorite`)
  ...
  async getScenarioComments(scenarioId, params = {}) {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios/${scenarioId}/comments`, {
        params: {
          page: params.page || 1,
          limit: params.limit || 20
        }
  ...
  async addComment(scenarioId, commentData) {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios/${scenarioId}/comments`, commentData)
  ...
  async updateComment(commentId, updates) {
    try {
      const response = await apiClient.put(`${this.baseURL}/comments/${commentId}`, updates)
  ...
  async getPopularScenarios(limit = 10) {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios/popular`, {
        params: { limit }
      })
      return response.data
    } catch (error) {
  ...
  async getFeaturedScenarios() {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios/featured`)
      return response.data
    } catch (error) {
  ...
  async applyScenario(scenarioId, customizations = {}) {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios/${scenarioId}/apply`, {
        customizations,
  ...
  async customizeScenario(scenarioId, customizations) {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios/${scenarioId}/customize`, customizations)
      return response.data
    } catch (error) {
  ...
  async previewCustomization(scenarioId, customizations) {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios/${scenarioId}/preview`, customizations)
      return response.data
    } catch (error) {
  ...
  async exportScenario(scenarioId, format = 'json') {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios/${scenarioId}/export`, {
        params: { format },
        responseType: 'blob'
      })
      return response.data
  ...
  async importScenario(fileData, metadata = {}) {
    try {
      ...
      const response = await apiClient.post(`${this.baseURL}/scenarios/import`, formData, {
        headers: {
  ...
  async submitForApproval(scenarioId) {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios/${scenarioId}/submit-approval`)
  ...
  async getPendingApprovals() {
    try {
      const response = await apiClient.get(`${this.baseURL}/moderation/pending`)
      return response.data
    } catch (error) {
  ...
  async approveScenario(scenarioId, moderatorNotes = '') {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios/${scenarioId}/approve`, {
        moderatorNotes
      })
  ...
  async rejectScenario(scenarioId, reason, moderatorNotes = '') {
    try {
      const response = await apiClient.post(`${this.baseURL}/scenarios/${scenarioId}/reject`, {
        reason,
        moderatorNotes
      })
  ...
  async getSimilarScenarios(scenarioId, limit = 5) {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios/${scenarioId}/similar`, {
        params: { limit }
      })
      return response.data
    } catch (error) {
  ...
  async getScenarioAnalytics(scenarioId) {
    try {
      const response = await apiClient.get(`${this.baseURL}/scenarios/${scenarioId}/analytics`)
      return response.data
    } catch (error) {
  ...
  async getUserContributions(userId, params = {}) {
    try {
      const response = await apiClient.get(`${this.baseURL}/users/${userId}/contributions`, {
        params: {
          page: params.page || 1,
          limit: params.limit || 10,
  ...
  async getForumDiscussions(scenarioId) {
    try {
      const response = await apiClient.get(`/api/forum/discussions`, {
        params: { scenarioId }
      })
      return response.data
    } catch (error) {
  ...
  async createForumDiscussion(scenarioId, discussionData) {
    try {
      const response = await apiClient.post(`/api/forum/discussions`, {
        ...discussionData,
        scenarioId
      })
      return response.data
