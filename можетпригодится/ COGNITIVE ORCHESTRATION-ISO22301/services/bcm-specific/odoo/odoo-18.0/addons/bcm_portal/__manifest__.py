...
• Data encryption''',
    ...
    'depends': [
        ...
        'bcm_training',
        'bcm_exercise',
        'bcm_governance',      # CRITICAL UPDATE: Added for compliance dashboards
        'bcm_community',       # CRITICAL UPDATE: Added for knowledge portal
        'bcm_intelligent_base', # CRITICAL UPDATE: Added for AI integration
    ],
    'external_dependencies': {
        'python': ['requests', 'PyJWT', 'werkzeug']
    },
    'data': [
