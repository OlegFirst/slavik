/**
 * BCM Service
 * Core service for BCM platform integration
...
const API_ENDPOINTS = {
  AI_ORCHESTRATOR: process.env.NEXT_PUBLIC_AI_ORCHESTRATOR_URL || 'http://localhost:8000',
  BCM_CORE: process.env.NEXT_PUBLIC_BCM_CORE_URL || 'http://localhost:8069',
  BIA_ENGINE: process.env.NEXT_PUBLIC_BIA_ENGINE_URL || 'http://localhost:8082',
  DOCUMENT_PROCESSOR: process.env.NEXT_PUBLIC_DOCUMENT_PROCESSOR_URL || 'http://localhost:8083',
  EVENTBUS: process.env.NEXT_PUBLIC_EVENTBUS_URL || 'http://localhost:8001',
