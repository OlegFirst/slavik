...
• AI predictions''',
    ...
    'data': [
        ...
        'data/personal_digital_twin_data.xml',
        'data/data_collection_orchestrator_data.xml',

        # Views
        'views/digital_twin_organization_views.xml',
        'views/digital_twin_simulation_views.xml',
        'views/digital_twin_config_views.xml',
        'views/personal_digital_twin_views.xml',
        'views/twin_data_package_views.xml',
        'views/data_collection_orchestrator_views.xml',
        'views/personal_twin_connector_views.xml',
        'views/digital_twin_menu.xml',

        # Wizards
        'wizard/personal_twin_wizard_views.xml',
        'wizard/twin_package_wizard_views.xml',
        'wizard/data_collection_wizard_views.xml',
    ],
    # 'demo': [
