...
export function reportRoutes(reportGenerator: ReportGenerator, projectAnalyzer: ProjectAnalyzer): Router {
  ...
  router.post('/validate-template', async (req: AuthenticatedRequest, res: Response) => {
    try {
  ...
  router.get('/history', async (req: AuthenticatedRequest, res: Response) => {
    try {
      ...
      const userHistory = history.filter((record: any) => 
  ...
  router.post('/save-to-history', async (req: AuthenticatedRequest, res: Response) => {
    try {
