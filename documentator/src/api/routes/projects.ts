...
export function projectRoutes(projectAnalyzer: ProjectAnalyzer): Router {
  ...
  router.get('/templates/:projectPath', async (req: AuthenticatedRequest, res: Response) => {
    try {
  ...
  router.get('/templates/:projectPath/:templateId/variables', async (req: AuthenticatedRequest, res: Response) => {
    try {
      const projectPath = decodeURIComponent(req.params.projectPath);
  ...
  router.get('/validate-path', async (req: AuthenticatedRequest, res: Response) => {
    try {
  ...
  router.get('/:projectPath/summary', async (req: AuthenticatedRequest, res: Response) => {
    try {
      const projectPath = decodeURIComponent(req.params.projectPath);
