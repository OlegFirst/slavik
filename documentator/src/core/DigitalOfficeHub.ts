...
export class DigitalOfficeHub {
  ...
  constructor() {
    ...
    this.agentRegistry = new AgentRegistry(this.agentScheduler);
    this.agentLoader = new AgentLoader('./src/agents', this.agentRegistry);
  ...
  private async handleEnableAgent(args: any) {
    const { agentName } = args;
  ...
  private async handleDisableAgent(args: any) {
    const { agentName } = args;
  ...
  private async handlePauseAgent(args: any) {
    const { agentName } = args;
  ...
  private async handleResumeAgent(args: any) {
    const { agentName } = args;
  ...
  private async handleAgentHealthCheck(args: any) {
