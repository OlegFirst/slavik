...
exports.DocumentatorService = void 0;
...
const DocumentChecker_1 = require("../../core/DocumentChecker");
const DocumentFiller_1 = require("../../core/DocumentFiller");
class DocumentatorService extends BaseService_1.BaseService {
    constructor() {
        super(...arguments);
        this.metadata = {
            name: 'documentator',
    ...
    async onInitialize() {
        ...
        this.documentChecker = new DocumentChecker_1.DocumentChecker();
        this.documentFiller = new DocumentFiller_1.DocumentFiller();
    ...
    async handleCheckDocument(args) {
    ...
    formatErrorsSummary(checkResult) {
    ...
    async handleFillNextQuestion(args) {
    ...
    async handleFillSubmitAnswer(args) {
    ...
    async handleFillGetStatus(args) {
        const { sessionId } = args;
        try {
            const session = this.documentFiller.getSession(sessionId);
            if (!session) {
...
exports.DocumentatorService = DocumentatorService;
//# sourceMappingURL=DocumentatorService.js.map