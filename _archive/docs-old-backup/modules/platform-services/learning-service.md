...
The Learning Service provides training, awareness, and competency development for business continuity management. It implements learning paths, assessments, certification tracking, and skills gap analysis.

## Metrics

| Metric | Value |
|--------|-------|
| **Total Lines of Code** | 6,267 |
| **Python Files** | 33 |
| **Classes** | 83 |
| **Functions** | 45 |
| **API Endpoints** | 34 |
...
# Run with coverage
pytest tests/ --cov=learning_service --cov-report=html
```
...
await client.start_workflow(type="learning")
```
