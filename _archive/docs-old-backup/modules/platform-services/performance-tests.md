...
The Performance Tests provides core business continuity management functionality.

## Metrics

| Metric | Value |
|--------|-------|
| **Total Lines of Code** | 4,248 |
| **Python Files** | 12 |
| **Classes** | 12 |
| **Functions** | 86 |
| **API Endpoints** | 0 |
...
```bash
cd platform-services/performance-tests
...
# Run with coverage
pytest tests/ --cov=performance_tests --cov-report=html
```
...
await client.start_workflow(type="performance")
```
