...
The Planning Service manages business continuity planning processes including plan development, maintenance, and testing. It implements structured planning workflows with template management and version control.

## Metrics

| Metric | Value |
|--------|-------|
| **Total Lines of Code** | 6,201 |
| **Python Files** | 35 |
| **Classes** | 50 |
| **Functions** | 10 |
| **API Endpoints** | 20 |
...
# Run with coverage
pytest tests/ --cov=planning_service --cov-report=html
```
...
await client.start_workflow(type="planning_service")
```
